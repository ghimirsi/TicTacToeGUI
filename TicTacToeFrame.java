    ...
    public void createGamePanel() {
        for (int row = 0; row < 3; row++)
        {
            for (int col = 0; col < 3; col++)
            {
                ...
                board[row][col].setFont(new Font("Times New Roman", Font.PLAIN, 50));
    ...
    public void results() {
        if(moves >= WIN_MOVES)
        {
            if(isWin(player) == true) {
                ...
                int resultDisplay = JOptionPane.showConfirmDialog(pane, "Congratulation player " + player + "! WoW You win! \n Do you want to play again?" + JOptionPane.YES_NO_OPTION);
